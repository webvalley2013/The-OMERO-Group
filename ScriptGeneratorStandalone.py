...
""".format(image_input_declaration=image_input_declaration,
        ...
        sm = ScriptsManager(user=scriptParams["Omero Server Admin Username"], pwd=scriptParams["Omero Server Admin Password"], host=scriptParams["Omero Server Host"], port=scriptParams["Omero Server Port"])
