        ...
        for t in range(image.getSizeT()):
            for z in range(image.getSizeZ()):
                for c in range(image.getSizeC()):
                    i = conn.createImageFromNumpySeq(planeGen(z, c, t, pixels),
                                                     makeImageName(image, z, c, t, scriptParams), 1, 1, 1,
                                                     description=getImageDescription(image, z, c, t), dataset=dataset)
